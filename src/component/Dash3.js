...
export default function Dash3() {
  return (
    <div>
     <div style={{ marginRight: "53%", marginTop: "2%" }}>
            <h5>search results "Philipe One Blade"</h5>
          </div>
          <Box p={5} pt={1} pb={0.5} className="dash_box-prd3">
        <Paper>
        <Link to={`/Congrats`} >
          <Box className="dash_box" p={1}>
            ...
            <div className="review_word">
              <div className="firstline_box">
                ...
                <FavoriteIcon className="fav_iconprd3" />
                <span className="fav_icon_numprd3">1,789</span>
                <CommentIcon className="cmt_iconprd3" />
              </div>
              <div className="para_nameprd3">Awesome</div>
              <span className="paraprd3">
                ...
                noreason why I'd even try something else. Read more...
              </span>
            </div>
          </Box>
          </Link>
